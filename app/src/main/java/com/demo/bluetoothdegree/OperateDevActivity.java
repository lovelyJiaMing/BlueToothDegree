...
public class OperateDevActivity extends Activity {
    ...
    boolean m_bPressZero = false;
    boolean m_bFirstZero = true;
    ...
    private void analysisStrDisplay(String sHex) {
        ...
        if (sRecordJianQ.isEmpty() && sRecordMianZ.isEmpty() && sRecordXiaH.isEmpty()) {
            ...
            if (m_bPressZero) {
                ...
                minus1 = minus1 > 180 ? minus1 - (double) 360 : minus1;
                if (minus1 > 0)
                    sminus1 = "左";
                else
                    sminus1 = "右";
                ...
                minus3 = minus3 > 180 ? minus3 - (double) 360 : minus3;
                if (minus3 > 0)
                    sminus3 = "左";
                else
                    sminus3 = "右";
